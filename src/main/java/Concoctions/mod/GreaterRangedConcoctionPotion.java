...
public class GreaterRangedConcoctionPotion extends SimplePotionItem {

    public GreaterRangedConcoctionPotion() {
        super(50, Rarity.RARE, "greaterrangedconcoctionbuff", 300, "greaterrangedconcoctiontip");
